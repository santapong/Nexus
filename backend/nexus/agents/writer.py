"""Writer Agent — content and business writing specialist (Phase 2).

Handles content writing, email drafting, documentation,
and business communication tasks.
"""
...
class WriterAgent(AgentBase):
    """Writer agent — executes content writing and communication tasks."""

    async def handle_task(self, message: AgentCommand, session: AsyncSession) -> AgentResponse:
        """Execute a writing task using the Pydantic AI agent with tools."""
